    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          ...
          <h3>React JS / Ant Design / Redux Toolkit</h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p>
            ...
            accessing API endpoints. I using React best practices, State
            Management Redux Toolkit, UI Creation using Ant Design, creating
            charts using Chart.js, and fetching data from multiple sources using
            RapidAPI
          </p>
          <a
            href="https://github.com/trenersem/cryptoo-app"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://crypto-stats-by-semenov.netlify.app/"
            target="_blank"
            rel="noreferrer"
          >
